...
See `app.core.security` for why this only decodes tokens rather than
issuing them, and why it is a small intentional duplicate of identity's
equivalent module rather than a shared dependency.
"""
